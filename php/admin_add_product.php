...
<body>
    ...
    <div class="container">
        ...
        <div class="addform" style="width: 50%; margin: 0 auto; text-align: center; border-collapse: collapse; padding-top: 20px;">
            ...
            <form action="insert_products.php" class="add_products" method="post" enctype="multipart/form-data">
                <div style="background-color: #f2f2f2; padding: 15px; border: 1px solid #ddd;">
                    <label for="product_name" style="padding-right: 10px;">Product Name:</label>
                    <input type="text" name="product_name" id="product_name" placeholder="Enter Product Name" class="input_fields">
                </div>

                <div style="background-color: #f2f2f2; padding: 15px; border: 1px solid #ddd;">
                    <label for="category_name" style="padding-right: 10px;">Category:</label>
                    <select name="category_id" id="category_id" class="input_fields" onchange="updateInput(this.value)">
                        <?php
                        // Fetch category data from the product_category table
                ...
                <div style="background-color: #f2f2f2; padding: 15px; border: 1px solid #ddd;">
                    <label for="product_price" style="padding-right: 10px;">Price:</label>
                    <input type="number" name="product_price" id="product_price" placeholder="Enter Price" class="input_fields">
                </div>

                <div style="background-color: #f2f2f2; padding: 15px; border: 1px solid #ddd;">
                    <label for="product_quantity" style="padding-right: 10px;">Quantity:</label>
                    <input type="number" name="product_quantity" id="product_quantity" placeholder="Enter Quantity" class="input_fields">
                </div>


                <div style="background-color: #f2f2f2; padding: 15px; border: 1px solid #ddd;">
                    <label for="product_description" style="padding-right: 10px;">Product Description:</label>
                    <input type="text" name="product_description" id="product_description" placeholder="Enter Product Description" class="input_fields" style="height: 60px;">
                </div>

                <div style="background-color: #f2f2f2; padding: 15px; border: 1px solid #ddd;">
                    <label for="product_image" style="padding-right: 10px;">Product Image:</label>
                    <input type="file" name="product_image" id="product_image" required accept="image/png, image/jpg, image/jpeg" class="input_fields">
                </div>
    ...
    function updateInput(value) {
        document.getElementById("selected_category").value = value;
    }
